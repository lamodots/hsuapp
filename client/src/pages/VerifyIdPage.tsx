...
function VerifyIdPage() {
	...
	return (
		<div className='px-4  pt-24 pb-16 w-dvw h-dvh overflow-hidden bg-[url("./assets/grad-bg.png")] bg-cover'>
			<header>
				<h2 className='text-center text-2xl text-zinc-950'>
				...
				<div className='flex justify-center'>
					...
					>
						...
						/>
						<Button
							title={isSubmitting ? 'Checking ID ...' : 'Check ID'}
							type='submit'
			...
			<main className='pt-16'>
				<p className='text-center'>
					Your ID is: <Tag tagText='Not Ready' ready={false} />
				</p>
			</main>
		</div>
	);
